...
//Client has a single torrent for now
//Future - more than one torrent for a client
//TODO
type Client struct {
	tor goTorrent.GoTorrent
}
...
//DownloadTorrent is useful for multitorrent client => in the future
//For a singletorrent client, t.DownloadAll() will be used
func (cl *Client) DownloadTorrent(t *goTorrent.GoTorrent) {
	t.DownloadAll()
}
